...
<br /><br />
  6.  Опасность в том что код применяется без подтверждения, например если изменили имя, то ресурс будет удален и создан заново. auto-approve может быть полезен в скриптах при автоматизации.  <br />
